...
if __name__ == "__main__":
    ...
    hypotest_call_string =  infile + ',' + wsName + ',' + modelSBName + ',' + modelBName + ',' + dataName + ',' + calculatorType + ',' + testStatType + ',' + useCLs + ',' + npoints + ',' + poimin + ',' + poimax + ',' + ntoys + ',' + useNumberCounting + ',' + nuisPriorName
    ...
    workspace_preparer(input_sig, signame, input_bkg, bkgname, input_dat, datname, config_file_name)
    ...
    os.system('root -l "StandardHypoTestInvDemo.C(' + hypotest_call_string  + ')"')
